...
pca envhabit1 envhabit2 envhabit3 envhabit4 envhabit5 envhabit6 envhabit7 envhabit8 envhabit9 , comp(4)  
screeplot, yline(1) 
predict pd1 pd2 pd3 pd4 pd5 pd6 pd7, score
...
tex(fragment) nonote noobs ///
    addtext(Covariates, NO) ///
    addstat(Mean dep. var., r(mean), Observations, e(N), Left bandwidth, e(h_l), Right bandwidth, e(h_r), Order polyn., e(p))
