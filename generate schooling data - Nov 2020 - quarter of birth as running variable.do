...
renpfix c_
keep hidp pidp big5* birth* delay*
gen round = 3
sort pidp 
...
***Sub-sample: PD1	
**By gender
rdplot pd1 qb if male==1, c(1957.4)   bwselect(mserd) covs(birthm male)   ci(95) shade  graph_options(xlabel (1930 (5) 1990) legend(off) xtitle("Quarter of birth") ytitle("Pro-environmental behaviours: pd1")  )  vce(hc0) masspoints(adjust) stdvars(on)

graph export "/Users/nattavudhpowdthavee/Dropbox/Education and sustainability/Ecological Econ/Revision/Fig_men_pd1.png", as(png) name("Graph") replace

rdrobust pd1 qb if male==1, c(1957.4)    bwselect(mserd) covs(birthm male)   vce(hc0) masspoints(adjust) stdvars(on)

outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Education and sustainability/Ecological Econ/Revision/Sub-sample_pd1.xls", replace ///
tex(fragment) nonote noobs ///
    addtext(Covariates, NO) ///
    addstat(Mean dep. var., r(mean), Observations, e(N), Effective N left of cut-off, e(N_h_l), Effective N right of cut-off, e(N_h_r), Bandwidth, e(h_l), Order polyn., e(p))

rdplot pd1 qb if male==0, c(1957.4)   bwselect(mserd) covs(birthm male)   ci(95) shade  graph_options(xlabel (1930 (5) 1990) legend(off) xtitle("Quarter of birth") ytitle("Pro-environmental behaviours: pd1")  )   vce(hc0) masspoints(adjust) stdvars(on)

graph export "/Users/nattavudhpowdthavee/Dropbox/Education and sustainability/Ecological Econ/Revision/Fig_women_pd1.png", as(png) name("Graph") replace

rdrobust pd1 qb if male==0, c(1957.4)    bwselect(mserd) covs(birthm male)   vce(hc0) masspoints(adjust) stdvars(on)
 
outreg2 using "/Users/nattavudhpowdthavee/Dropbox/Education and sustainability/Ecological Econ/Revision/Sub-sample_pd1.xls", append ///
tex(fragment) nonote noobs ///
    addtext(Covariates, NO) ///
    addstat(Mean dep. var., r(mean), Observations, e(N), Effective N left of cut-off, e(N_h_l), Effective N right of cut-off, e(N_h_r), Bandwidth, e(h_l), Order polyn., e(p)) 
  
**By region
 rdplot pd1 qb if south==1, c(1957.4)   bwselect(mserd) covs(birthm male)   ci(95) shade  graph_options(xlabel (1930 (5) 1990) legend(off) xtitle("Quarter of birth") ytitle("Pro-environmental behaviours: pd1")  )  vce(hc0) masspoints(adjust) stdvars(on)
 
 graph export "/Users/nattavudhpowdthavee/Dropbox/Education and sustainability/Ecological Econ/Revision/Fig_south_pd1.png", as(png) name("Graph") replace

 rdrobust pd1 qb if south==1, c(1957.4)    bwselect(mserd) covs(birthm male)   vce(hc0) masspoints(adjust) stdvars(on)
...
tex(fragment) nonote noobs ///
 ...
 rdplot pd1 qb if south==0, c(1957.4)   bwselect(mserd) covs(birthm male)   ci(95) shade  graph_options(xlabel (1930 (5) 1990) legend(off) xtitle("Quarter of birth") ytitle("Pro-environmental behaviours: pd1")  )  vce(hc0) masspoints(adjust) stdvars(on)
 
 graph export "/Users/nattavudhpowdthavee/Dropbox/Education and sustainability/Ecological Econ/Revision/Fig_north_pd1.png", as(png) name("Graph") replace

 rdrobust pd1 qb if south==0, c(1957.4)    bwselect(mserd) covs(birthm male)   vce(hc0) masspoints(adjust) stdvars(on)
...
rdplot pd1 qb if high_income==0, c(1957.4)   bwselect(mserd) covs(birthm male)   ci(95) shade  graph_options(xlabel (1930 (5) 1990) legend(off) xtitle("Quarter of birth") ytitle("Pro-environmental behaviours: pd1")  )  vce(hc0) masspoints(adjust) stdvars(on)
 
graph export "/Users/nattavudhpowdthavee/Dropbox/Education and sustainability/Ecological Econ/Revision/Fig_lowincome_pd1.png", as(png) name("Graph") replace

rdrobust pd1 qb if high_income==0, c(1957.4)    bwselect(mserd) covs(birthm male)   vce(hc0) masspoints(adjust) stdvars(on)
...
rdplot pd1 qb if high_income==1, c(1957.4)   bwselect(mserd) covs(birthm male)   ci(95) shade  graph_options(xlabel (1930 (5) 1990) legend(off) xtitle("Quarter of birth") ytitle("Pro-environmental behaviours: pd1")  )  vce(hc0) masspoints(adjust) stdvars(on)
 
graph export "/Users/nattavudhpowdthavee/Dropbox/Education and sustainability/Ecological Econ/Revision/Fig_lowincome_pd1.png", as(png) name("Graph") replace

rdrobust pd1 qb if high_income==1, c(1957.4)    bwselect(mserd) covs(birthm male)   vce(hc0) masspoints(adjust) stdvars(on)
...
**2nd R&R
use "/Users/nattavudhpowdthavee/Documents/UKHLS regional data/UKDA-6666-stata/stata/stata11/oslaua.dta", clear
encode oslaua, gen(oslaua_)
collapse oslaua_, by(pid)
drop if oslaua_==.
sort pidp
save "/Users/nattavudhpowdthavee/Documents/UKHLS regional data/UKDA-6666-stata/stata/stata11/oslaua_.dta", replace

use "/Users/nattavudhpowdthavee/Dropbox/Education and sustainability/schooling_effect_England_Wales.dta", clear
sort pidp
merge 1:m pidp  using "/Users/nattavudhpowdthavee/Documents/UKHLS regional data/UKDA-6666-stata/stata/stata11/oslaua_.dta"

**Cluster by local authority district
rdrobust pc1  qb , c(1957.4)   bwselect(mserd) covs(birthm male)   vce(cluster oslaua_) masspoints(adjust) stdvars(on)  
rdrobust pd1  qb , c(1957.4)   bwselect(mserd) covs(birthm male)   vce(cluster oslaua_) masspoints(adjust) stdvars(on)  
